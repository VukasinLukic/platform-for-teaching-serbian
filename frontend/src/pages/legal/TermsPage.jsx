        ...
        <Card variant="elevated">
          <CardBody className="p-12">
            ...
            <div className="prose prose-lg max-w-none space-y-6 text-gray-700">
              ...
              <section>
                <h2 className="text-2xl font-bold text-ink mt-8 mb-4">4. Plaćanje i povraćaj novca</h2>
                <ul className="list-disc ml-6 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-bold text-ink mt-8 mb-4">6. Ponašanje korisnika</h2>
                <p>Zabranjeno je:</p>
                <ul className="list-disc ml-6 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-bold text-ink mt-8 mb-4">7. Ograničenje odgovornosti</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-ink mt-8 mb-4">10. Zakon i jurisdikcija</h2>
                <p>
