...
export default function EmptyState({ pose = 'reading', title, text, action = null, compact = false }) {
  return (
    <div
      className={`flex flex-col ${compact ? 'sm:flex-row sm:text-left' : ''} items-center text-center gap-4 sm:gap-6 bg-gradient-to-br from-paper-100 to-white border border-gray-100 rounded-3xl ${
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <h3 className="text-lg sm:text-xl font-bold text-ink mb-1.5">{title}</h3>
